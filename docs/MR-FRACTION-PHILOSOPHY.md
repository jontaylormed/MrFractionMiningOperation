...
#### 2.5a AMENDMENT — scoring is permitted; grading is not (user decision, 2026-08-19)

**This is the second time a non-negotiable has been amended by the user rather than by a review**, and §4.4 predicted this one: *"non-negotiable 7 is the one most likely to be challenged first."* It is recorded here rather than quietly applied, in the same way non-negotiable 4 was.

> **The user's words:** *"I am ok with some scoring, but we are not grading… This is more exploration as much as possible, but they need to see if they smelted correctly and got something useful."*

The original invariant collapsed two different things into one prohibition. Separating them:

**A grade summarises the student. A score inventories the world.** *"You are at 70%"* is a verdict on a person. *"You have 14 ingots"* is a fact about a yard. The first is what a demoralised student converts into an identity claim; the second is what a game has always been allowed to say.

**Five tests, so this is decidable rather than a matter of taste:**

| | grade | score |
|---|---|---|
| **Is there a maximum?** | yes — so falling short is built in | no — it can only grow |
| **Does failure subtract?** | yes | no; a wrong move simply adds nothing |
| **Does it aggregate history into a verdict?** | yes | no; it is the present state of your holdings |
| **What does comparing two students reveal?** | their worth | how long they played |
| **Is it about you, or about this lump?** | you | this lump |

**So, permitted:** counts of ore mined and metals owned, a yard that fills, gear that appears because you went somewhere, an unopened shaft becoming an opened one. **Still forbidden:** percentages, accuracy rates, X-out-of-Y, letter grades, ranks, leaderboards, streaks that break, and anything that goes *down*.

**And the part that carries the real weight of the user's sentence.** *"They need to see if they smelted correctly"* is not a request for marking — it is a request for **verification**, and the design answer is that correctness lives in the **physics of the world rather than in a mark**. You pour your metals into the mold and the casting comes out clean or visibly deformed. That signal is immediate, private, self-evident, and about *this lump* — so it satisfies every test above while telling the student exactly what a grade would have told them, and more usefully.

**The risk this accepts, stated so it can be watched:** an accumulating visible quantity is one design decision away from being a score in the forbidden sense — the moment it acquires a ceiling, a comparison, or a subtraction. §6c.3 gains a seventh claim to test: *does a filling yard read as exploration, or does the first student who compares yards turn it into a grade after all?* Only a real classroom settles it.
