...
**The cursor over the floor is a hammer** — a 32px SVG with its hotspot on the striking face. It is the only affordance left saying what this place is for, now that no button on screen says it. The belt and the buttons inside the box keep a plain pointer.
