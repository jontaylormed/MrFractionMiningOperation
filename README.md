...
[![Checks](https://img.shields.io/badge/MF.validate()-26%2C335%20checks-4A6FA5?style=flat-square)](docs/VERIFICATION.md)
...
docs/VERIFICATION.md             101 rules, each written after a real failure
...
- `docs/VERIFICATION.md` is the collaboration's actual output: 101 rules, each one written
