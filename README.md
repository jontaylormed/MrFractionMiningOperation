...
[![Checks](https://img.shields.io/badge/MF.validate()-13%2C174%20checks-4A6FA5?style=flat-square)](docs/VERIFICATION.md)
...
docs/VERIFICATION.md             95 rules, each written after a real failure
...
95 verification rules and most of the prose were worked out in conversation and are
attributed as such:
...
- `docs/VERIFICATION.md` is the collaboration's actual output: 95 rules, each one written
